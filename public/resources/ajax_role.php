...
if( !empty($requestData['search']['value']) ) {   // if there is a search parameter, $requestData['search']['value'] contains search parameter
    ...
    $sql.=" OR slug LIKE '%".$requestData['search']['value']."%' "; 
...
$ro=$table::findOrFail($row['id']);	
 if($ro->id!=1)
 {
	$code='<li><button onClick="archiveFunction('.$ro->id.')" type="button" name="sub_delete" class="btn"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trash-2 icon"><polyline points="3 6 5 6 21 6"></polyline><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"></path><line x1="10" y1="11" x2="10" y2="17"></line><line x1="14" y1="11" x2="14" y2="17"></line></svg></button></li>';	
...
$nestedData[] = ucfirst($ro->slug);
$nestedData[] = datetime_to_text($ro->created_at);
$nestedData[] = datetime_to_text($ro->updated_at);
$nestedData[] = '<ul class="table-controls">
<li><a class="btn" href="'.TP_BACK_SIDE.$url.'/edit/'.$ro->id.'" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-2"><path d="M17 3a2.828 2.828 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5L17 3z"></path></svg></a></li>'.$code.'</ul>';
