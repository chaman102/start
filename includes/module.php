...
<?php
  ...
  public static function form_data()
  {
    ...
    echo $fo = Forms::input("Name", "name", $name, 1, 0);
    echo $fo = Forms::input("Heading", "heading", $heading, 1, 0);
    echo $fo = Forms::input("Link Url", "link", $link, 0, 0);
