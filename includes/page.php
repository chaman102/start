...
public static function show($pname, $action)
    {
        echo '<form name="form" class="widget-content" action="deleteall.php" method="post">
	 ...
	 <div class="col-xl-10 col-lg-9 col-sm-10">
	   <select id="country" class="form-control" name="mid" required>
		 <?php
		       ...
		       $menu1=Menu::where("group_id",0)->get();
					   ...
					   {			
							   ...
							   $sub=Menu::where("group_id",$menus->id)->get();
							   foreach($sub as $ro)
							   {
						   ...
						   if($m2!=0)
							   ...
							   $sub1=Menu::where("group_id",$ro->id)->get();
						   foreach($sub1 as $ro1)
					   {	
						   ...
						   if($m3!=0)
							   ...
							   $sub2=Menu::where("group_id",$ro1->id)->get();
						   foreach($sub2 as $ro2)
					   {	
